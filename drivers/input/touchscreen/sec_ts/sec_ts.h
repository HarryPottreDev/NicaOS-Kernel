...
#define OFFSET_CAL_TMP			4	/* for COB type*/
...
#define SEC_TS_CMD_KEY_RAW_MODE			0x7E
#define SEC_TS_READ_KEY_RAW_VALUE		0x7F
...
#define SEC_TS_CMD_TMP_PANELCALIBRATION	0xDF
...
#define SEC_TS_VENDOR_ACK_OFFSET_CAL_NEEDED		0x23
...
struct sec_ts_data {
	...
	int irq_key_count[SUPPORT_TSK_NUM];	
